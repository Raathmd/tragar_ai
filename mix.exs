defmodule TragarAi.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:swoosh, "~> 1.16"},
      {:req, "~> 0.5"},
      # Deterministic (model-free) extraction of ticket attachments.
      {:nimble_csv, "~> 1.2"},
      {:xlsx_reader, "~> 0.8"},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind tragar_ai", "esbuild tragar_ai"],
      "assets.deploy": [
        "tailwind tragar_ai --minify",
        "esbuild tragar_ai --minify",
        "phx.digest"
      ],
