defmodule TragarAiWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :tragar_ai
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :tragar_ai
  end
